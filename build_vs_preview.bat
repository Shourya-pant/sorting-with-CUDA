...
echo.
echo Compiling with command: nvcc -I./include -o build/gpu_sorting src/main.cpp src/sort.cu -std=c++14 -ccbin="C:\Program Files\Microsoft Visual Studio\2022\Preview\VC\Tools\MSVC\14.44.34918\bin\Hostx64\x64" -allow-unsupported-compiler
echo.

nvcc -I./include -o build/gpu_sorting src/main.cpp src/sort.cu -std=c++14 -ccbin="C:\Program Files\Microsoft Visual Studio\2022\Preview\VC\Tools\MSVC\14.44.34918\bin\Hostx64\x64" -allow-unsupported-compiler
